...
class StaticClassA
{
    ...
    {
        /**
         * self resuelve a la StaticClassA así se invoque desde la StaticClassB,
         * esto sucede gracias al early biding. No se puede acceder a la propiedad
         * $name sobre escrita en el hijo
         */
        return self::$name;
    }
}
